	...
	*/
	...
	/*
		int* (*x[10])(void);
				 1				1. array of
			  2					2. pointer to
						3		3. function with no argument
		 4						4. returning pointer to int
	*/



	/* A funation can't return an array */
	//int f(int)[];			// Wrong
	...
	FCN_PTR_ARRAY x3;		// int (*x3[10])(int);
	...
	int* off[3][4];			// A 3 x 4 array of pointers to int
