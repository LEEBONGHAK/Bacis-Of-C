...
## 섹션 11. 문자열 함수들
 ...
 - [x] 11.3 문자열의 배열
 - [x] 11.4 문자열을 입력받는 다양한 방법들
 - [x] 11.5 문자열을 출력하는 다양한 방법들
 - [x] 11.6 다양한 문자열 함수들
 - [x] 11.7 선택 정렬 문제 풀이
 - [x] 11.8 문자열의 포인터를 정렬하기
 - [x] 11.9 문자 함수를 문자열에 사용하기
 - [x] 11.10 명령줄 인수
...
## 섹션 12. Storage Classes, Linkage and Memory Management
 ...
 - [x] 12.3 변수의 영역과 연결 상태, 객체의 지속 기간
 - [x] 12.4 저장 공간의 다섯 가지 분류
 - [x] 12.5 자동 변수
 - [x] 12.6 레지스터 변수
 - [x] 12.7 블록 영역의 정적 변수
 - [x] 12.8 정적 변수의 외부 연결 external linkage
 - [x] 12.9 정적 변수의 내부 연결 internal linkage
 - [x] 12.10 변수의 저장 공간 분류 요약 정리
 - [x] 12.11 함수의 저장 공간 분류
 - [x] 12.12 난수 생성기 모듈 만들기 예제
 - [x] 12.13 메모리 동적 할당
...
## 섹션 13. 파일 입출력
 ...
 - [x] 13.1 파일 입출력의 작동 원리
 - [x] 13.2 텍스트 파일 입출력 예제
 - [x] 13.3 텍스트 인코딩과 코드 페이지
 - [x] 13.4 텍스트 파일 입출력 함수들
 - [x] 13.5 바이너리 파일 입출력
 - [x] 13.6 파일 임의 접근
 - [x] 13.7 기타 입출력 함수들
 - [x] 13.8 텍스트 파일을 바이너리 처럼 읽어보기


## 섹션 14. 구조체

 - [x] 14.1 구조체가 필요한 이유
 - [x] 14.2 구조체의 기본적인 사용법
 - [x] 14.3 구조체의 메모리 할당
 - [x] 14.4 구조체의 배열 연습문제
 - [x] 14.5 구조체를 다른 구조체의 멤버로 사용하기
 - [x] 14.6 구조체와 포인터
 - [x] 14.7 구조체를 함수로 전달하는 방법
 - [x] 14.8 구조체와 함수 연습문제
 - [x] 14.9 구조체와 할당 메모리
 - [x] 14.10 복합 리터럴
 - [x] 14.11 신축성있는 배열 멤버
 - [x] 14.12 익명 구조체
 - [x] 14.13 구조체의 배열을 사용하는 함수
 - [x] 14.14 구조체 파일 입출력 연습문제
 - [x] 14.15 공용체의 원리
 - [x] 14.16 공용체와 구조체를 함께 사용하기
 - [x] 14.17 익명 공용체
 - [x] 14.18 열거형
 - [x] 14.19 열거형 연습문제
 - [x] 14.20 이름공간 공유하기
 - [x] 14.21 함수 포인터의 원리
 - [x] 14.22 함수 포인터의 사용 방법
 - [x] 14.23 자료형에게 별명을 붙여주는 typedef
 - [x] 14.24 복잡한 선언을 해석하는 요령
 - [x] 14.25 qsort 함수 포인터 연습문제
 - [x] 14.26 함수 포인터의 배열 연습문제
